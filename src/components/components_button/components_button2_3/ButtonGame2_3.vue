...
export default {    
  ...
  methods: {    
    openLink(item, action) {    
      const links = {    
        'Игра 1': { скачать: 'https://link-to-game-1' },    
    ...
    getImages(item) { 
      const images = { 
        'Игра 1': ['src/assets/Загадки_для_детей_О_животных1.jpg','src/assets/Загадки_для_детей_О_животных2.jpg','src/assets/Загадки_для_детей_О_животных3.jpg'], 
