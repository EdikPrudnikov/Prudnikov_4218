<template>   
  ...
  <div class="container">   
    <h1>Страница "Презентации 6-7 лет"</h1>   
...
export default {  
  ...
  methods: {  
    ...
    getImages(item) { 
      const images = { 
        'Презентация 1': ['src/assets/Загадки_для_детей_О_животных1.jpg','src/assets/Загадки_для_детей_О_животных2.jpg','src/assets/Загадки_для_детей_О_животных3.jpg'], 
        'Презентация 2': [''], 
