<template>
      <div class="container">
      <h1>Страница "4-5 года"</h1>
      <p>Здесь будет информация о 4-5.</p>
    ...
    <button @click="goToButtonDOCX4_5" class="custom4-button">Текст</button> 
    </div>
</template>
...
export default {
    ...
    goToButtonDOCX4_5() { 
      this.$router.push('/ButtonDOCX4_5'); // переход на страницу "презентации" 
    },
  } 
};
