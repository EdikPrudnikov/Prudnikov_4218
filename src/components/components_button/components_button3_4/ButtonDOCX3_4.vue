<template>   
  ...
  <div class="container">   
    <h1>Страница "Сценарии 3-4 года"</h1>   
...
export default { 
  ...
  methods: { 
    openLink(item, action) { 
      const links = { 
        'Считалочки': { скачать: 'https://getfile.dokpub.com/yandex/get/https://disk.yandex.ru/i/4yonQDx6lrxF0A' }, 
    ...
    getImages(item) { 
      const images = { 
        'Считалочки': ['src/assets/Считалочки/Считалочки1.png','src/assets/Считалочки/Считалочки2.png','src/assets/Считалочки/Считалочки3.png'], 
